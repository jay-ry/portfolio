  ...
  return (
    <ContentPage code="POL-01" label="PRIVACY" title="PRIVACY POLICY." intro="This policy explains what information may be processed when you use jayandrade.com and its related services.">
      ...
      <section className="content-panel">
        ...
        <p>This site shows a cookie banner on first visit. What it asks depends on where you are visiting from, which is determined from the country the network reports for your connection; that country is not stored or linked to you. In the European Economic Area, the United Kingdom and Switzerland — and whenever the country cannot be determined — no advertising script is loaded until you choose Accept, and Reject or ignoring the banner means no advertising cookies at all. Everywhere else the banner is a notice: advertising is on by default and Turn off ads switches it off. You can change that choice at any time, wherever you are: <CookieSettingsButton /></p>
      </section>
      <section className="content-panel">
        <h2>GDPR / EEA &amp; UK VISITORS</h2>
        <p>If you are located in the European Economic Area, the United Kingdom or Switzerland, non-essential cookies — including the advertising cookies described above — are only set with your consent, given or withheld through the cookie banner or the Cookie settings control on this page. The same applies if the site cannot determine where you are visiting from, because an undetermined location is treated as if it were in these territories. Where processing relies on consent, you may withdraw it at any time with the same control, without affecting processing carried out before the withdrawal.</p>
      ...
      <section className="content-panel">
        ...
        <p>This site does not sell personal information for money. California residents have the right under the CCPA to opt out of the &quot;sale&quot; or &quot;sharing&quot; of personal information, which for this site means opting out of interest-based advertising cookies. Selecting Turn off ads in the cookie banner — or reopening Cookie settings above and choosing Reject — serves as this site&apos;s opt-out mechanism, and it stops the advertising script loading from that point on. You can also exercise your CCPA rights via the <Link href="/contact">contact form</Link>.</p>
      </section>
